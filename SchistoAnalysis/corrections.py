...
class Schistosomiasis(ss.Infection):
    ...
    def __init__(self, pars=None, par_dists=None, *args, **kwargs):
        ...
        pars = ss.omergeleft(pars,
            ...
            densdep_fec = 0.0007, # density dependent fecundity #egg dependency
            efficacy = 0.86, # drug efficacy
            lifespan = 5.7, # mean adult worm lifespan 
            max_fecundity = 0.34, # maximum fecundity 
            human_cercarae_prob = 1, # probability of human-cercarae probability 
            ...
            beta_env = 1,  # Scaling factor for transmission from environment, # contact rate
            ...
            decay_rate = 0.0625,
            half_sat_rate = 0,    # Rate at which bacteria in the environment dies (per day), from Chao et al. and Mukandavire et al. citing https://pubmed.ncbi.nlm.nih.gov/8882180/
            p_env_transmit = 1,    # Probability of environmental transmission - filled out later
        )
